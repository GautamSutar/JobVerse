    ...
    <div className="font-sans w-full">
      ...
      <section className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <motion.div
          ...
          className="relative z-10 text-center text-black px-4 max-w-2xl"
        >
          <motion.h1
          ...
          >
            Practice real interview scenarios, receive instant feedback, and
            improve your skills—all through our AI-driven mock interview
            platform.
          </motion.p>
          <motion.div
          ...
          >
            <motion.button
              ...
              className="bg-white text-gray-900 px-6 py-2 rounded-full font-semibold transition transform"
            >
              Start Practicing
            </motion.button>
            <motion.button
              {...cardHover}
              className="bg-blue-600 text-white px-6 py-2 rounded-full font-semibold transition transform"
            >
              Book a Demo
            </motion.button>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 text-blue-900">
                Engage in AI Interviews
              </h3>
              <p className="text-blue-700">
                Our AI simulates real interview scenarios tailored to your
                goals.
              </p>
            </motion.div>
            {/* Step 3 */}
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            ...
            <motion.div
              variants={fadeInUp}
              {...cardHover}
              className="flex flex-col items-center p-6 bg-white rounded-lg shadow-md transition"
            >
              <div className="text-5xl mb-3">
                <span
                  role="img"
                  aria-label="Realistic Simulation"
            ...
            >
              ...
              <p className="text-blue-700 text-center">
                Get real-time analysis and actionable insights after each
                session.
              </p>
            </motion.div>
            {/* Feature Card 3 */}
            ...
            >
              <div className="text-5xl mb-3">
                <span
                  role="img"
                  aria-label="Customizable Experience"
                  className="text-blue-600"
                >
                  🎛
                </span>
              ...
              <p className="text-blue-700 text-center">
                Tailor your mock interview sessions to match various industries
                and roles.
              </p>
            </motion.div>
            {/* Feature Card 4 */}
            ...
            >
              ...
              <p className="text-blue-700 text-center">
                Our system adjusts to your progress to provide personalized
                practice.
              </p>
            </motion.div>
            {/* Feature Card 5 */}
            ...
            >
              ...
              <p className="text-blue-700 text-center">
                Detailed analytics and reports to track your improvement over
                time.
              </p>
            </motion.div>
          </motion.div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="bg-blue-100 text-blue-800 p-3 rounded-lg max-w-xs">
                    <p className="text-sm">
                      Hello, I'm your virtual interviewer. Are you ready to
                      start?
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <div className="bg-blue-100 text-blue-800 p-3 rounded-lg max-w-xs">
                    <p className="text-sm">
                      Great! Can you tell me about a time when you overcame a
                      challenge?
                    </p>
                  </div>
                </div>
                <div className="flex items-end justify-end">
                  <div className="bg-blue-600 text-white p-3 rounded-lg max-w-xs">
                    <p className="text-sm">
                      I faced a major issue with project delays, but I managed
