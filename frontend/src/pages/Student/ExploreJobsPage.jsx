  ...
  const handleResumeUpload = async () => {
    ...
    try {
      await axiosInstance.post(
        `job-applications/apply-job/${selectedJobId}/`,
        formData,
        {
          headers: {
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start">
                  ...
                  <div className="mt-4 sm:mt-0 sm:ml-6 flex-shrink-0">
                    <button
                      ...
                      className={`inline-flex items-center cursor-pointer px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white ${
        ...
        <div className="fixed inset-0 bg-black/30 bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-lg shadow-2xl w-full max-w-lg">
            ...
            <div className="flex justify-end gap-4">
              <button
                className="px-6 py-2 rounded-md cursor-pointer text-sm font-medium text-gray-700 bg-gray-200 hover:bg-gray-300 disabled:opacity-50"
              ...
              <button
                className="px-6 py-2 cursor-pointer rounded-md text-sm font-medium text-white bg-green-600 hover:bg-green-700 disabled:opacity-50"
